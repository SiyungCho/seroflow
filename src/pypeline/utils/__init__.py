...
These functions simplify operations such as:
    ...
    - Managing files and directories, including:
        ...
        * Checking the existence and validity of directories and files (check_directory, check_file).
        * Creating directories and files (create_directory, create_file).
    - Manipulating strings related to file paths, such as splitting by delimiters and removing file extensions 
