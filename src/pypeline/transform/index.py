...
It provides classes to set a specified column as the index (SetIndex) and to reset the index (ResetIndex) of a DataFrame.
Each transformation updates the DataFrame stored in the pypeline context.
"""
...
class SetIndex(Transformation):
    ...
    The transformation updates the DataFrame in the pypeline context by using the pandas set_index method.
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            step_name (str, optional): The name of this transformation step. Defaults to "SetIndex".
...
class ResetIndex(Transformation):
    ...
    The transformation updates the DataFrame in the pypeline context by resetting its index,
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            step_name (str, optional): The name of this transformation step. Defaults to "ResetIndex".
            on_error (str, optional): The error handling strategy.
        """
        self.dataframe = dataframe
        self.drop = drop
    ...
    def func(self, context):
        ...
        Retrieves the DataFrame from the context, resets its index according to the specified parameters,
        updates the DataFrame in the context, and returns the updated context.
