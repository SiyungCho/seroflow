...
This module implements transformation classes for performing string operations on columns within a DataFrame.
These transformations modify the string values of a specified column by either removing characters, replacing substrings,
or removing multiple characters. Each transformation extends the base Transformation class and updates the DataFrame
in the pypeline context accordingly.
...
class RemoveCharacterFromColumn(Transformation):
    ...
    A transformation that removes all occurrences of a specific character from a specified string column in a DataFrame.
    The updated DataFrame is stored back in the context.
    ...
    def func(self, context):
        ...
        Retrieves the DataFrame from the context, removes the specified character from the target column,
...
class RemoveCharactersFromColumn(Transformation):
    ...
    A transformation that removes all occurrences of a list of specified characters from a target string column
    in a DataFrame. The updated DataFrame is stored back in the context.
    ...
    def func(self, context):
        ...
        Retrieves the DataFrame from the context, removes all specified characters from the target column,
        updates the DataFrame in the context, and returns the updated context.
...
class ReplaceStringInColumn(Transformation):
    ...
    A transformation that replaces all occurrences of a specified substring with another string in a target column
    of a DataFrame. The updated DataFrame is stored back in the context.
    ...
    def func(self, context):
        ...
        Retrieves the DataFrame from the context, replaces occurrences of the specified substring in the target column,
        updates the DataFrame in the context, and returns the updated context.
    ...
    def __replace_string(self, df):
        """
        Replaces all occurrences of the specified substring in the target column with the replacement string.
