...
Classes:
    ...
    ReloadCacheState: Reloads a cached state from the cache using a specified cache key and updates the pypeline's
...
class CacheState(Transformation):
    ...
    This transformation caches the current state of pypeline execution by storing deep copies of the parameter index
    and global context in the provided cache. It is typically used to create a checkpoint in the pypeline,
    allowing execution to resume from this point later if necessary.

    Attributes:
        cache: The cache object where the state is stored.
        parameter_index (dict): The current parameter index of the pypeline.
        globalcontext: The current global context of the pypeline.
    """
    def __init__(self,
                 cache,
                 parameter_index,
...
class ReloadCacheState(Transformation):
    ...
    This transformation reloads a previously cached state from the cache using a specified cache key.
    The reloaded state (parameter index and global context) is then applied to the pypeline, allowing execution
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            pypeline: The pypeline object whose state will be updated.
    ...
    def func(self):
        ...
        Retrieves the cached state using the cache key and updates the pypeline's parameter index and
        global context accordingly.
        """
...
class ResetCache(Transformation):
    ...
    This transformation resets the cache by clearing all cached state. It can optionally delete the underlying
    cache directory, ensuring that all cached data is removed.
    """
    def __init__(self,
                 cache,
        ...
        Arguments:
            ...
            delete_directory (bool, optional): If True, deletes the cache directory. Defaults to False.
            on_error (str, optional): The error handling strategy.
        """
        super().__init__(step_name=step_name,
                         func=self.func,
    ...
    def func(self):
        ...
        Calls the reset() method on the cache object, optionally deleting the cache directory if specified.
        """
