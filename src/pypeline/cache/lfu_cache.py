...
This module provides a concrete implementation of a cache using the Least Frequently Used (LFU) strategy.
The LFUCache class implements the AbstractCache interface to store, retrieve, and manage the states.
It supports caching of pypeline parameters and global context, along with mechanisms to evict the 
